...
SPACESHIP_DIR_COLOR="${SPACESHIP_DIR_COLOR:="blue"}"
...
SPACESHIP_HG_STATUS_DELETED="${SPACESHIP_HG_STATUS_DELETED:="x"}"
...
SPACESHIP_NODE_SYMBOL="${SPACESHIP_NODE_SYMBOL:="[node] "}"
...
SPACESHIP_XCODE_SYMBOL="${SPACESHIP_XCODE_SYMBOL:="[xcode] "}"
...
SPACESHIP_SWIFT_SYMBOL="${SPACESHIP_SWIFT_SYMBOL:="[swift] "}"
...
SPACESHIP_RUST_SYMBOL="${SPACESHIP_RUST_SYMBOL:="[rust] "}"
...
SPACESHIP_JULIA_SYMBOL="${SPACESHIP_JULIA_SYMBOL:="[julia] "}"
...
SPACESHIP_CONDA_SYMBOL="${SPACESHIP_CONDA_SYMBOL:="[conda] "}"
...
SPACESHIP_PYENV_SYMBOL="${SPACESHIP_PYENV_SYMBOL:="[pyenv] "}"
...
SPACESHIP_EMBER_SYMBOL="${SPACESHIP_EMBER_SYMBOL:="[ember] "}"
...
SPACESHIP_KUBECONTEXT_SYMBOL="${SPACESHIP_KUBECONTEXT_SYMBOL:="[kube] "}"
...
SPACESHIP_JOBS_SYMBOL="${SPACESHIP_JOBS_SYMBOL:="j"}"
...
SPACESHIP_EXIT_CODE_SYMBOL="${SPACESHIP_EXIT_CODE_SYMBOL:="x"}"
...
SPACESHIP_AWS_SYMBOL="${SPACESHIP_AWS_SYMBOL:="[aws]"}"
